						...
						while (true) { // 如果套接字是连接状态
							...
							if (line != null) {
								...
								try {
									...
									String sql = "insert into user (uName,pin,email) values(？,？,？)";// 定义SQL语句
